...
menuItem8 = MenuItem(name="Veggie Burger",
                     description='''Made with freshest
...
menuItem2 = MenuItem(
    ...
    prepared since the imperial era. The meat is prized for its thin,
    crisp skin, with authentic versions of the dish serving mostly the
    skin and little meat, sliced in front of the diners by the cook''',
...
menuItem6 = MenuItem(name="Ramen",
                     ...
                     of Chinese-style wheat noodles served
                     in a meat- or (occasionally)
...
menuItem3 = MenuItem(name="Gyoza",
                     ...
                     Japanese-style gyoza and Chinese-style jiaozi are
                     the rich garlic flavor, which is less noticeable
                     in the Chinese version, the light seasoning of
                     Japanese gyoza with salt and soy sauce,
...
menuItem3 = MenuItem(name="Mom's Spaghetti",
                     description='''Spaghetti with some
...
menuItem4 = MenuItem(name='''Choc Full O\' Mint (Smitten\'s
...
menuItem1 = MenuItem(name="Lamb Curry",
                     ...
                     tomatoes, onions and alllll those
...
menuItem3 = MenuItem(name="Potstickers",
                     description='''Delicious chicken and
...
menuItem4 = MenuItem(name="Nigiri Sampler",
                     description='''Maguro, Sake,
                     Hamachi, Unagi, Uni, TORO!''',
...
menuItem9 = MenuItem(name="Chicken Fried Steak",
                     ...
                     steak fried and smothered with cream gravy''',
                     price="$8.99", course="Entree", restaurant=restaurant1)
...
menuItem1 = MenuItem(name="Boysenberry Sorbet",
                     ...
                     of ripe berries turned into frozen
...
menuItem3 = MenuItem(name="Morels on toast (seasonal)",
                     description='''Wild morel mushrooms fried
                     in butter, served on herbed toast slices''',
...
menuItem4 = MenuItem(name="Tandoori Chicken",
                     ...
                     seasoned with a spicy mix(chilli, tamarind among others)
                     and slow cooked in a cylindrical clay or metal
...
menuItem1 = MenuItem(name="Super Burrito Al Pastor",
                     ...
                     Beans, Avocado, Cilantro, Salsa, Tortilla''',
